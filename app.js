...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    /* Pickup / delivery messaging — same rule set applies to both
       ...
       - Pickup: Gabby will share the address when she replies.
       - Delivery: £40 minimum order, free within 15 miles of Dundee,
         further afield possible especially on orders over £40. */
    const FULFILMENT_COPY = {
      pickup: "Great — Gabby will share the pickup address when she confirms your order.",
      delivery: "Delivery has a £40 minimum order and covers within 15 miles of Dundee. Need to go further? Let Gabby know in the details — it's often possible, especially on orders over £40.",
    };
    ...
    /* "Want this tailored to you?" links on menu cards jump to the
       custom order form and pre-fill the details field so Gabby
       knows which design sparked the enquiry. */
    document.getElementById('menu-grid').addEventListener('click', (e) => {
